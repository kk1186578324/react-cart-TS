                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                _a.trys.push([0, 2, , 3]);
                                return [4 /*yield*/, profile_1.register(values)];
                            case 1:
                                result = _a.sent();
                                if (result.success) {
                                    dispatch(connected_react_router_1.push('/login'));
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                _a.trys.push([0, 2, , 3]);
                                return [4 /*yield*/, profile_1.login(values)];
                            case 1:
                                result = _a.sent();
                                if (result.success) {
                                    sessionStorage.setItem('access_token', result.data);
                                    dispatch(connected_react_router_1.push('/profile'));
                                }
                                else {
