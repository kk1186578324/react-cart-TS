...
function HomeSliders(props) {
    ...
    return (react_1.default.createElement(antd_1.Carousel, { autoplay: true }, props.sliders.map(function (item, index) { return (react_1.default.createElement("div", { key: index },
