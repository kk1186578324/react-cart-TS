...
function Register(props) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(Nav_1.default, { history: props.history }, "\u6CE8\u518C"),
        react_1.default.createElement(antd_1.Form, __assign({}, layout, { className: "register-form", name: "basic", onFinish: onFinish }),
            ...
            react_1.default.createElement(antd_1.Form.Item, { label: "confirmPassword", name: "confirmPassword", rules: [{ required: true, message: 'Please input your confirmPassword!' }] },
                react_1.default.createElement(antd_1.Input.Password, null)),
            react_1.default.createElement(antd_1.Form.Item, { label: "Email", name: "email", rules: [{ required: true, message: 'Please input your email!' }] },
                react_1.default.createElement(antd_1.Input, null)),
            react_1.default.createElement(antd_1.Form.Item, __assign({}, tailLayout),
                react_1.default.createElement(antd_1.Button, { type: "primary", htmlType: "submit" }, "\u6CE8\u518C")))));
}
var mapStateToProps = function (state) { return state.profile; };
exports.default = react_redux_1.connect(mapStateToProps, profile_1.default)(Register);
